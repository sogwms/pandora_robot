...
void ano_parse_frame(uint8_t *buffer, uint8_t length)
{
	...
	if (*(buffer + 2) == 0X02)
	{
		if (*(buffer + 4) == 0X01)
		{
			...
			// f.send_pid5 = 1;
			// f.send_pid6 = 1;
			ano_send_pid(1, 1,2,3,0,0,0,0,0,0);
			// ano_send_pid(2, 2,2,3,1,2,3,1,2,3);
			// ano_send_pid(3, 3,2,3,1,2,3,1,2,3);
			// ano_send_pid(4, 4,2,3,1,2,3,1,2,3);
			// ano_send_pid(5, 5,2,3,1,2,3,1,2,3);
			// ano_send_pid(6, 6,2,3,1,2,3,1,2,3);
